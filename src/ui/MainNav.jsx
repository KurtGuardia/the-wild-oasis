  ...
  return (
    <nav>
      <NavList>
        ...
        <li>
          <StyledNavLink to='/bookings'><HiOutlineCalendarDays/>
          Bookings</StyledNavLink>
        </li>
        <li>
          <StyledNavLink to='/cabins'><HiOutlineHomeModern/>
          Cabins</StyledNavLink>
        </li>
        <li>
          <StyledNavLink to='/users'><HiOutlineUser/>
          Users</StyledNavLink>
        </li>
        <li>
          <StyledNavLink to='/settings'><HiOutlineCog6Tooth/>
